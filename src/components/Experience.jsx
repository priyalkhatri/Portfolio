    ...
    return [
      {
        ...
        subtitle: `Welcome to Priyal's Portfolio,
Have a seat and enjoy the ride!`,
      },
      {
        ...
        title: "About",
        subtitle: `A Web development maestro turned 3D virtuoso with Three.js, I'm Priyal. Beyond the code clock, I groove into dance steps, where pixels meet beats with equal zest. `,
      },
      {
        cameraRailDist: -1,
        position: new Vector3(
        ...
        subtitle: `Web developer proficient in HTML, CSS, and JavaScript, specializing in React.js. Recently added Three.js and React Three Fiber to the toolkit for exploring the 3D frontier.`,
      },
      {
        cameraRailDist: 1.5,
        position: new Vector3(
